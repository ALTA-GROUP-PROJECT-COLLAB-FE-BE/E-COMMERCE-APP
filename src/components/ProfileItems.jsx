...
function ProfileItems({ image, username, onClickEdit, onClickCreate, onClickProduct, onClickOrder, logoutHandler, onClickRemove }) {
  return (
    <div className="col-md-12 col-lg-12 col-12 justify-center" /*style={{ display: "flex", alignContent: "center" }}*/>
      <Card className="m-3 shadow-lg justify-content-center align-self-center">
        <Card.Body style={{ backgroundColor: "#ebecc1" }}>
          ...
          <Card.Title style={{ height: "5rem" }} className="text-wrap fs-5 fw-bold overflow-hidden row justify-content-center">
            {username}
          </Card.Title>
